    ...
    if option =="🖊️Επεξεργασία":
        ...
        if mycursor.rowcount!=0:
            ...
            if submit_button_edit:
                ...
                st.write("Το κόστος(€) εκκίνησης, δηλαδή το κεφάλαιο που χρειάζεται για την έναρξης της επιχειρηματικής ιδέας σας, είναι: "+str(round(SUM_ek,2)))
                st.write("Το Λειτουργικό κόστος(€), δηλαδή κόστος(€)v για τη λειτουργία της επιχειρηματικής ιδέας σας, για ένα έτος είναι: "+str(round(SUM_leit,2)))
                st.markdown(""" <table>
                                    <tr>
                                        <th>Κατηγορία</th>
                                        <th>Ετήσια απόσβεση</th>
                ...
                st.write("Συνεπώς, για να είναι βιώσιμη η επιχειρηματική ιδέα σας, κρίνεται απαραίτητο, το ελάχιστο των ετήσιων εσόδων να είναι: "+str(round(SUM_leit,2)))
                st.warning("Για κάθε επόμενο έτος λειτουργίας της επιχειρηματικής ιδέας σας, θα πρέπει να λάβετε υπόψιν τυχόν αύξηση του λειτουργικού κόστους (π.χ αυξήσεις μισθών, ανατιμήσεις αγαθών, κλπ.) και τις αποσβέσεις.")
        else:
            st.write("Δεν βρέθηκαν στοιχεία")
    if option=="➖Διαγραφή":
