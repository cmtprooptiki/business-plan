        ...
        if mycursor.rowcount!=0:
            ...
            with st.form(key="edit_form"):
                if selected_id:
                    ...
                    q6_1_ans_num=st.number_input('Συμπληρώστε νούμερο:',key="q6_1_ans_num", step=0.00,value=row[5])
                    q6_1_calc=q6_1_ans_num*0.04
            ...
            if submit_button_edit:
                ...
                st.write("Το κόστος(€) εκκίνησης, δηλαδή το κεφάλαιο που χρειάζεται για την έναρξης της επιχειρηματικής ιδέας σας, είναι:"+str(SUM_ek))
                st.write("Το Λειτουργικό κόστος(€), δηλαδή κόστος(€)v για τη λειτουργία της επιχειρηματικής ιδέας σας, για ένα έτος είναι:"+str(SUM_leit))
                st.markdown(""" <table>
                                    <tr>
                                        <th>Κατηγορία</th>
                                        <th>Ετήσια απόσβεση</th>
