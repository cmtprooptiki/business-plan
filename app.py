...
# year = st.selectbox("Select year", ["2021", "2022", "2023", "2024"])
        ...
        st.markdown("""<h4>Περιγράψτε τη διαδικασία παραγωγής και τις τυχόν αναγκαίες εγκαταστάσεις ή εξοπλισμό.</h4>
        <h4>Σχολιάστε την αλυσίδα εφοδιασμού και τα logistics της επιχειρηματικής ιδέας.</h4>
...
def e_button10(id,kpdf):
    ...
    if option =="Update":
        ...
        """)
                ...
                st.text("Πόσο υπολογίζετε το συνολικό ετήσιο κόστος μισθοδοσίας;")
                q15_1_ans_num = st.number_input('Kόστος:', key="q151ansnum",value=row[31])
                st.write('To Κόστος είναι:', q15_1_ans_num)
        ...
        """)
                ...
                st.text("Πόσο υπολογίζετε το συνολικό ετήσιο κόστος παροχής υπηρεσιών από τρίτους;")
                q16_1_ans_num = st.number_input('Kόστος:', key="q161ansnum",value=row[33])
                st.write('To Κόστος είναι:', q16_1_ans_num)
        ...
        Έπειτα υπολογίστε το συνολικό ετήσιο κόστος έκτακτων εξόδων.""")
                ...
                st.text("Πόσο υπολογίζετε το συνολικό ετήσιο κόστος έκτακτων εξόδων;")
                q17_1_ans_num = st.number_input('Kόστος:', key="q171ansnum",value=row[35])
                st.write('To Κόστος είναι:', q17_1_ans_num)
